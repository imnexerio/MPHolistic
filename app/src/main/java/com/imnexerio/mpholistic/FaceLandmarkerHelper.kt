...
class FaceLandmarkerHelper(
    ...
    val faceLandmarkerHelperListener: faceLandmarkerListener? = null
) {
    ...
    fun setupFaceLandmarker() {
        ...
        try {
            ...
            faceLandmarkerHelperListener?.onfacelandmarkerError(
...
//    }
    ...
    private fun returnLivestreamResult(
        ...
        if( result.faceLandmarks().size > 0 ) {
            ...
            faceLandmarkerHelperListener?.onfacelandmarkerResults(
                ResultBundle(
                    result,
                    inferenceTime,
                    input.height,
            ...
            faceLandmarkerHelperListener?.onfacelandmarkerEmpty()
        }
    }
    ...
    interface faceLandmarkerListener {
        ...
        fun onfacelandmarkerResults(resultBundle: ResultBundle)

        fun onfacelandmarkerEmpty() {}
    }
}